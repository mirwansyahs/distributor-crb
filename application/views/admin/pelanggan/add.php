<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <form id="form1" method="POST" action="<?=base_url()?>admin/pelanggan/addProccess">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="nama_pelanggan">Nama Pelanggan <span class="text-sm text-danger">*</span></label>
                        <input type="text" id="nama_pelanggan" class="form-control form-control-sm" name="nama_pelanggan" required>
                    </div>
                    <div class="form-group">
                        <label for="username">Username <span class="text-sm text-danger">*</span></label>
                        <input type="text" id="username" class="form-control form-control-sm" name="username" required>
                    </div>
                    <div class="form-group">
                        <label for="password">Password <span class="text-sm text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="kelompok_usia" class="form-control form-control-sm" name="kelompok_usia" required>
                    </div>
