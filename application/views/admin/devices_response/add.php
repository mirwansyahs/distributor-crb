<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <form id="form1" method="POST" action="<?=base_url()?>admin/deviceresponse/addProccess/<?=$code?>">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="kodeDevice">Kode Perangkat <span class="text-sm text-danger">*</span></label>
                        <input type="text" id="kodeDevice" class="form-control form-control-sm" name="device_code" value="<?=$code?>" required>
                    </div>
                    <div class="form-group">
                        <label for="nomorResponse">Nomor Respon <span class="text-sm text-danger">*</span></label>
                        <input type="number" id="nomorResponse" class="form-control form-control-sm" name="response_number" required min="1" max="9999" value="1">
                    </div>
                    <div class="form-group">
                        <label for="nilaiResponse">Nilai Respon <span class="text-sm text-danger">*</span></label>
                        <input type="text" id="nilaiResponse" class="form-control form-control-sm" name="response_value" required>
                    </div>
